  ...
  */
  ...
  function allCarsApp() {
    ...
    function handleSubmitFormCar(event) {
      ...
      var carFieldsValues = [ $carBrandModel.get()[0].value, $carYear.get()[0].value, $carPlate.get()[0].value, $carColor.get()[0].value ];
      var $image = document.createElement('img');
      $image.setAttribute('src', $carImage.get()[0].value);
